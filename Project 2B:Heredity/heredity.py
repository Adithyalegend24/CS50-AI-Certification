...
def joint_probability(people, one_gene, two_genes, have_trait):
    ...
    for person, info in people.items():
        ...
        if info["mother"] is None:
            joint *= PROBS["gene"][genes] * trait_prob
        else:
            def pass_prob(parent):
                g = 1 if parent in one_gene else 2 if parent in two_genes else 0
                if g == 0:
            ...
            m = pass_prob(info["mother"])
            f = pass_prob(info["father"])
